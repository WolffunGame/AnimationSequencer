...
namespace BrunoMikoski.AnimationSequencer
{
    public static class ContextClickUtils
    {
		...
		private static AnimationStepBase stepSource;
        ...
        public static void SetSource(AnimationStepBase targetSource)
        {
			stepSource = targetSource;
        }
		...
		public static void ApplySourceToTargetByCustom(int indexTarget, System.Action<AnimationStepBase, int> modifyCallback) 
		{
			if (source == null)
				return;

			modifyCallback?.Invoke(stepSource, indexTarget);
		}
